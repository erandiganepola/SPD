...
print
'Fit Vectorizer to train set', trainVectorizerArray
print
'Transform Vectorizer to test set', testVectorizerArray
...
sentence = u'කැමරාව පමණක් අතැතිවය. මෙම ගමනේ අතිශය දුෂ්කර'.encode(
    'utf-8')  # unicode to str("කැමරාව පමණක් අතැතිවය. මෙම ගමනේ අතිශය දුෂ්කර")
train_set = [sentence, doc1, doc2, doc3]

tfidf_vectorizer = TfidfVectorizer()
tfidf_matrix_train = tfidf_vectorizer.fit_transform(train_set)  # finds the tfidf score with normalization
print
"cosine scores ==> ", cosine_similarity(tfidf_matrix_train[0:1],
